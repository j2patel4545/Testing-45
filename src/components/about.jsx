...
function About() {
  ...
  return (
    <div id='about' data-scroll data-scroll-section data-scroll-speed="-.1" className='w-full relative flex h-screen py-5 px-5 rounded-tl-3xl rounded-tr-3xl bg-[#CDEA68] font-["NeueMontreal"] text-4xl text-black flex-col'>
